...
class ViewController: UIViewController, UITableViewDelegate {
    ...
    func handleError(error: NSError) {
        let message: String = self.mapErrorCodeToErrorMessage(errorCode:
            DownloadErrorCodes(rawValue:
            downloadErrorCodes.RawValue(error.code)))
    ...
    func setPosterImageForCell(_ movieCell: MovieCell,
                               AtIndexPath indexPath: IndexPath,
                               fromPosterPath posterPath: String) {
